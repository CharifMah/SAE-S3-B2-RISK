...
namespace Models.Graph.distances
{
    public class FloydWarshall
    {
        ...
        {
            tableauDistances = new Dictionary<Lieu, Dictionary<Lieu, int>>();
            tableauPredecesseurs = new Dictionary<Lieu, Dictionary<Lieu, Lieu>>();
            tableauRoutes = new Dictionary<Lieu, Dictionary<Lieu, Route>>();
        }
