...
namespace WebSocketApiControllerExample.Tests
{
    public class WebSocketApiControllerTests
    {
        ...
        private static WebSocketsController CreateController(IConnectionFactory connectionFactory,
            IConnectionManager connectionManager)
        {
            var controller = new WebSocketsController(connectionFactory, connectionManager)
            {
