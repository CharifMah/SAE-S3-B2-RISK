...
namespace ModelsAPI.Converters
{
    ...
    /// <typeparam name="TImplementation">The Type that specifies the class that will be created.</typeparam>
    public class ConcreteListConverter<TInterface, TImplementation> : JsonConverter where TImplementation : TInterface, new()
    {
        /// <summary>
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            if (objectType == typeof(TInterface))
            {
                ...
                if (jsonToken is JObject || jsonToken is JArray)
                {
                    ...
                    // ***
                    returnValue = new List<TImplementation>();
